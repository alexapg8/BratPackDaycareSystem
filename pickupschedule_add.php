    ...
    <div class="container <?= $hideform ?>">
        ...
        <form action="" method="post">
            <div class="form-group row">
                <label for="date" class="col-sm-2 col-form-label" style="text-align:left;" > Date:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="child_first_name" class="col-sm-2 col-form-label" style="text-align:left;" > Child First Name :</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="child_last_name" class="col-sm-2 col-form-label" style="text-align:left;" > Child Last Name :</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="pickup_first_name" class="col-sm-2 col-form-label" style="text-align:left;" > Pickup First Name:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="pickup_last_name" class="col-sm-2 col-form-label" style="text-align:left;" > Pickup Last Name:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="pickup_phone_number" class="col-sm-2 col-form-label" style="text-align:left;" > Pickup Phone Number:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="pickup_email" class="col-sm-2 col-form-label" style="text-align:left;" > Pickup Email:</label>
                <div class="col-sm-10">
