    ...
    <div class="navbar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="contact_list.php?status=not yet viewed">Not Yet Viewed</a>
                <a class="dropdown-item" href="contact_list.php?status=in-process">In-Process</a>
                <a class="dropdown-item" href="contact_list.php?status=responded">Responded</a>
            </div>
        </div>
        <div>
