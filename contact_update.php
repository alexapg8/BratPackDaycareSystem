...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <div class="form-group row">
            <label for="first_name" class="col-sm-2 col-form-label" style="text-align:left;" > First Name :</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="last_name" class="col-sm-2 col-form-label" style="text-align:left;" > Last Name :</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="email" class="col-sm-2 col-form-label" style="text-align:left;" > Email :</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="phone_number" class="col-sm-2 col-form-label" style="text-align:left;" > Phone Number :</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="message" class="col-sm-2 col-form-label" style="text-align:left;" > Message :</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="status" class="col-sm-2 col-form-label" style="text-align:left;" > Status :</label>
            <div class="col-sm-6">
            <select id="status" name="status" class="form-control">
                <option value="not yet viewed" <?php if ($status == "not yet viewed")
                    echo "selected";
                ?> >Not Yet Viewed</option>
                <option value="in-process" <?php if($status == "in-process")
                    echo "selected";
                ?> >In-Process</option>
                <option value="responded" <?php if($status == "responded")
                    echo "selected";
                ?> >Responded</option>
            </select>
            </div>
